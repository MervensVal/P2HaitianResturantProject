...
namespace HaitianRestaurantApp2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        //Adding role manager via dependency injection
        //this lets you add roles to the user
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManager.Roles.Where(u => u.Name != Constants.RoleCustomer).Select(x => x.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.CreateAsync(user, Input.Password); //This creates the user
                if (result.Succeeded)
                {
