...
namespace HaitianRestaurantApp2.Areas.Admin.Controllers
{
    ...
    public class LocationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocationId,LocationName,StreetAddress,City,State,ZipCode,PhoneNumber")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationId,LocationName,StreetAddress,City,State,ZipCode,PhoneNumber")] Location location)
        {
